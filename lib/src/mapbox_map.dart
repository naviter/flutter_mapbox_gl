...
class MapboxMap extends StatefulWidget {
  const MapboxMap({
    ...
    this.useVirtualDeviceMode = false,
  ...
  /// Set virtual device mode when embedding Mapbox into Flutter - causes crashes on Oudies and Samsung devices
  final bool useVirtualDeviceMode;
...
class _MapboxMapState extends State<MapboxMap> {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, dynamic> creationParams = <String, dynamic>{
      ...
      'useVirtualDeviceMode': widget.useVirtualDeviceMode,
    };
