...
class MapboxWebGlPlatform extends MapboxGlPlatform
  ...
  @override Future<CameraPosition?> queryCameraPosition() => throw UnimplementedError();
  @override Future<List> querySourceFeatures(String sourceId, List<String> sourceLayers, {String? filter}) => throw UnimplementedError();
  ...
  @override Future<void> setMaximumFps(int value) => throw UnimplementedError();
}
